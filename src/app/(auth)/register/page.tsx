    ...
    <div className="w-full max-w-4xl">
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="card-box">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            <div>
              ...
              <input type="text" required className="input" value={salonName} onChange={(e) => setSalonName(e.target.value)} placeholder="Hair Salon NORTH TOKYO" />
            </div>
            <div>
        ...
        <div className="space-y-4">
          <div className="card-box brand-light-bg border-blue-200">
            <h2 className="font-bold text-stone-900 mb-3">選ばれる理由</h2>
            <ul className="space-y-3 text-sm">
              <Benefit text="月額 ¥4,980〜 美容室特化SaaS" />
