...
export const metadata = {
  title: 'プライバシーポリシー — HairSalonLink',
  description: 'HairSalonLink の個人情報の取扱いに関するプライバシーポリシー。',
};
  ...
  return (
    <>
      ...
      <p className="text-[13.5px] text-[#bdaa88] mb-10 leading-[2.05]">
        HairSalonLink (以下「本サービス」) を運営する事業者 (以下「当方」) は、本サービスを通じて取得する個人情報を、日本の「個人情報の保護に関する法律」 (以下「個人情報保護法」) その他関連法令を遵守し、以下のとおり適切に取り扱います。
      </p>
      ...
      <Section n="第 1 条" title="取得する個人情報の項目">
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>来店履歴、予約履歴、施術内容、薬剤カルテ、アレルギー情報</li>
      ...
      <Section n="第 10 条" title="お問合せ窓口">
        ...
        <div className="mt-3 p-4 bg-[#1b1510] border border-[#302519] rounded-sm">
          <div className="text-[12px] text-[#a89778] mb-1">個人情報お問合せ窓口</div>
          <div className="text-[13.5px] text-[#efe3c8]">shibahara.724@gmail.com</div>
        </div>
      </Section>

      <p className="mt-12 text-[12px] text-[#7a6850] tracking-wide">
        制定: 2026 年 5 月 25 日
      </p>
    </>
  );
