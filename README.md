...
- **スタイルギャラリー** — スタイリスト型のビジュアル訴求を管理SaaSに統合
...
| ロール | メール | パスワード | 画面 |
|---|---|---|---|
| SuperAdmin | `super@hairsalonlink.demo` | `super1234` | `/superadmin` |
| 管理者 | `owner@hairsalonlink.demo` | `owner1234` | `/dashboard` |
| スタッフ | `staff@hairsalonlink.demo` | `staff1234` | `/dashboard` (権限制限) |
...
| **Light** | **¥4,980/月** | 顧客300名・予約無制限・LINE連携・クーポン・分析 |
| Standard | ¥9,980/月 | 顧客無制限・AI分析・スタイルギャラリー |
